...
<body style="background-image: url('<?php echo base_url().'assets/logo/backci.png';?>'); background-size: cover;background-repeat:  no-repeat;">
  ...
  <a></a>
  <ul class="main-nav">
 <li> <a href="<?php echo base_url();?>admin_home/customerpage"><i class="fa fa-home"></i> Home</a></li>
  <li><a href="<?php echo base_url();?>admin_home/customerpage"><i class="fa fa-shopping-bag"></i> Shop</a></li>
  <li><a href="#"><i class="fa fa-question"></i> About us</a></li>
  <li><a href="<?php echo base_url();?>main/login"><i class="fa fa-power-off"></i> Logout</a></li>
</ul>
</nav>
<div class="container">
